VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DR_PAY 
   Bindings        =   "DR_PAY.dsx":0000
   Caption         =   "IMPRIMER LISTE DES PAYEMENTS"
   ClientHeight    =   11055
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   10590
   Icon            =   "DR_PAY.dsx":0011
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "LISTE DES PAYEMENTS"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
...
Private Sub DataReport_Initialize()
    ...
    Set DR_PAY.Sections("Section4").Controls("EcoleLogo").Picture = LoadPicture(App.Path & "\EcoleLogo.jpg")
    DR_PAY.Sections("Section3").Controls("EcoleFoot").Caption = GetSetting("Ecole_nom")
